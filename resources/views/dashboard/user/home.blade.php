...
<div class="space-y-8 divide-y divide-gray-200 p-10" x-data="{ openNinWallet: false, openBvnWallet: false}">
    ...
    <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
        <div class="space-y-6 sm:space-y-5">
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">Start by choosing what Identity Information you’re authenticating your wallet with.</p>
                </div>
                <div class="items-end">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">{{ auth()->user()->ssn }}</h3>
                </div>
        ...
        <div class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
            <div class="rounded-tl-lg rounded-tr-lg sm:rounded-tr-none relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-500">
                <div>
            ...
            <div class="sm:rounded-tr-lg relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-500">
                <div>
                ...
                <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
                    @if($wallets->firstWhere('type', 'bvn'))
                    <svg class="h-6 w-6 text-green-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
                    </svg>
                    @else

                ...
                <div class="pointer-events-auto w-screen max-w-md" x-show="openBvnWallet" x-transition:enter="transform transition ease-in-out duration-500 sm:duration-700" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transform transition ease-in-out duration-500 sm:duration-700" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full">
                    <form class="flex h-full flex-col divide-y divide-gray-200 bg-white shadow-xl" method="POST" action="{{ route('create-bvn-wallet') }}">
                            ...
                            <div class="bg-purple-700 py-6 px-4 sm:px-6">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="ml-3 flex h-7 items-center">
                                        <button type="button" class="rounded-md bg-purple-700 text-purple-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white" @click="openBvnWallet = false;">
                                ...
                                <div class="mt-1">
                                    <p class="text-sm text-purple-300">Kindly fill in the required information as it is.</p>
                                ...
                                <div class="divide-y divide-gray-200 px-4 sm:px-6">
                                    <div class="space-y-8 pt-6 pb-5">
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="first_name" id="first_name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm" readonly value="Oluwaseun1">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="last_name" class="block text-sm font-medium text-gray-900">Last name</label>
                                            <div class="mt-1">
                                                <input type="text" name="last_name" id="last_name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm" readonly value="Akinmukomi">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="email" class="block text-sm font-medium text-gray-900">Email</label>
                                            <div class="mt-1">
                                                <input type="email" name="email" id="email" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm" readonly value="doluwasegun@seamfix.com">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="phone" class="block text-sm font-medium text-gray-900">Phone</label>
                                            <div class="mt-1">
                                                <input type="text" name="phone" id="phone" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm" readonly value="08167396655">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="bvn" class="block text-sm font-medium text-gray-900">BVN</label>
                                            <div class="mt-1">
                                                <input type="text" name="bvn" id="bvn" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm" readonly value="22231411111">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="date_of_birth" class="block text-sm font-medium text-gray-900">Date of Birth</label>
                                            <div class="mt-1">
                                                <input type="text" name="date_of_birth" id="date_of_birth" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm" readonly value="19-Aug-1991">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="flex flex-shrink-0 justify-end px-4 py-4">
                            <button type="button" class="rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2" @click="openBvnWallet = false;">Cancel</button>
